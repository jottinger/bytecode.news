    ...
    <div>
      ...
      {entries.length === 0 ? (
        <div className="py-12 text-center">
          <p className="section-label text-muted-foreground/70 mb-3">
              ...
              >
                <div className="flex items-baseline justify-between gap-4 mb-1.5">
                  <div className="flex items-baseline gap-3 min-w-0">
                    <span
                      className="text-muted-foreground/60 font-mono text-xs tabular-nums shrink-0"
                  ...
                  <time className="byline text-muted-foreground/60 shrink-0">
