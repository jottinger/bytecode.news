    ...
    <section className="py-8 md:py-12">
      <div className="max-w-2xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-10">
          <div>
            <p className="byline text-muted-foreground mb-1">Username</p>
            <p className="text-foreground">{auth.principal.username}</p>
          </div>
          <div>
            <p className="byline text-muted-foreground mb-1">Role</p>
        ...
        <div className="border-t border-border/40 pt-8 mb-8">
          ...
          <form className="flex gap-3 items-end" onSubmit={onSave}>
            <div className="flex-1">
              <label className="byline text-muted-foreground block mb-1.5" htmlFor="display-name">
