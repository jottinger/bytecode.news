      ...
      <section className="py-8 md:py-12">
        <div className="max-w-3xl mx-auto px-6 md:px-8">
          ...
          <div className="py-12 text-center">
            <p className="section-label text-muted-foreground/70 mb-4">
    ...
    <section className="py-8 md:py-12">
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        ...
        <form onSubmit={onSubmit}>
          {/* Title */}
          <div className="mb-6">
            <label className="byline text-muted-foreground/70 block mb-1.5" htmlFor="post-title">
              Title
            </label>
            <input
              id="post-title"
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-1.5">
              <label className="byline text-muted-foreground/70" htmlFor="post-markdown">
                Content (Markdown)
              </label>
          ...
          {auth.principal && (
            <div className="mb-6">
              <div className="flex items-center justify-between mb-1.5">
                <label className="byline text-muted-foreground/70" htmlFor="post-summary">
                  Summary (optional)
                </label>
                {canDeriveSummary && (
                  <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="byline text-muted-foreground/70" htmlFor="post-tags">
                  Tags
                </label>
            ...
            <div>
              <label className="byline text-muted-foreground/70 block mb-1.5" htmlFor="post-categories">
                Categories
              </label>
              <input
                id="post-categories"
